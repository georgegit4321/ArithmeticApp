        ...
        find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (a>b) {
                        Toast.makeText(getApplicationContext(), Integer.toString(a) + " is largest", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(getApplicationContext(), Integer.toString(b) + " is largest", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
